...
import { DoneQuiz, Quiz } from '../../data/quizzes';
import ChatHubScreen from './MessagesScreen';
...
interface StudentDashboardProps {
  ...
  // FIX: Added missing onSendMessageToConversation prop.
...
const StudentDashboard: React.FC<StudentDashboardProps> = ({ 
  ...
  return (
    <div className="w-full max-w-sm mx-auto h-screen flex flex-col text-gray-800 dark:text-white font-sans overflow-hidden">
      ...
      <main className={`flex-grow overflow-y-auto pb-24 ${!isFullScreenView ? 'p-4 space-y-4' : ''}`}>
        {renderContent()}
      </main>
